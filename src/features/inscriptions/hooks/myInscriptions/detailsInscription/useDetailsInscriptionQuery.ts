import { detailsInscriptionAction } from '@/features/inscriptions/actions/myInscriptions/detailsInscription/detailsInscriptionAction';
...
export function useDetailsInscriptionQuery(inscriptionId: string) {
  return useQuery<DetailsInscriptionResponse>({
    ...
    queryFn: () => detailsInscriptionAction(inscriptionId),
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
    retry: 2,
