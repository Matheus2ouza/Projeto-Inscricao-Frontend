import { deleteInscriptionAction } from '@/features/inscriptions/actions/deleteInscription/deleteInscriptionAction';
...
import {
  ...
  UpdateInscriptionSchemaType,
} from '../../schema/myInscriptions/updateInscriptioSchema';
import { DetailsInscriptionKey } from './detailsInscription/useDetailsInscriptionQuery';
...
export function useFormUpdateInscription({
  ...
  const mutation = useMutation({
    mutationFn: async (values: UpdateInscriptionSchemaType) => {
      return await updateInscriptionAction(inscriptionId, values);
    },
    onSuccess: async () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      ...
      return deleteInscriptionAction(inscriptionId);
    },
    onMutate: async () => {
