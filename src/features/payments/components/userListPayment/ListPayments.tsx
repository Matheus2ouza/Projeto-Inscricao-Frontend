              ...
              <div className="mt-4 space-y-4">
                  ...
                  <div className="border-riodavida/20 bg-riodavida/5 overflow-hidden rounded-md border p-3 sm:p-4">
                    {selectedPayment.imageUrl ? (
                      <div className="flex flex-col items-center justify-center">
                        <div className="bg-riodavida/5 mb-3 flex h-20 w-full items-center justify-center rounded sm:h-25">
                ...
                <div className="space-y-2">
                  ...
                  selectedPayment.allocation.length > 0 ? (
                    ...
                    <div className="border-riodavida/20 bg-riodavida/5 flex items-center justify-center rounded-md border px-4 py-3 sm:py-4">
                      <p className="text-muted-foreground text-sm">
