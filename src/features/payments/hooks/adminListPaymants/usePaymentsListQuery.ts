import { getPaymentsList } from '@/features/payments/api/adminListPaymants/getPaymentsList';
import { ListAllPaymentsResponse } from '@/features/payments/types/adminListPaymants/listPayments.types';
