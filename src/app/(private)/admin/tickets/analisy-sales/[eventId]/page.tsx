...
export default function AnalyzeTicketSalesAdminEventPage() {
  ...
  const handleBack = () => {
    router.push("/admin/tickets/sale");
  };
  ...
  if (isLoading && !event) {
    return (
      <PageContainer
        title="Vendas de Tickets"
        description="Visualize todas as solicitações e pré-vendas deste evento."
        showBackButton
