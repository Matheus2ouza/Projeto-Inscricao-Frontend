...
const STORAGE_KEY = "checkin-admin-page-size";

function getStoredPageSize(defaultSize = 10) {
...
export default function CheckInAdminPage() {
  ...
  return (
    <PageContainer
      title="Check-in"
      description="Gerencie as contas que precisam ser confirmadas para o evento."
      showBackButton
