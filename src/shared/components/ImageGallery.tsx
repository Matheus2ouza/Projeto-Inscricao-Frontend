...
export default function ImageGallery({
  ...
  const handleFileChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const nextFiles = files.slice(0, remainingSlots || files.length);
  ...
  const handlePasteFile: UploadProps['beforeUpload'] = (file) => {
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            {editing && onAddImages ? (
              <label
                ...
                className="hover:border-primary hover:bg-primary/10 inline-flex cursor-pointer items-center gap-2 rounded-full border border-dashed border-slate-300 bg-slate-50 px-4 py-2 text-sm font-medium text-slate-700 transition dark:border-zinc-700 dark:bg-zinc-900 dark:text-slate-200"
              >
